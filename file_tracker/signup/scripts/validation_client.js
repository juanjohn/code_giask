...
>>>>>>> e23252e80bb556846beb0b1095f93862019f9777
	...
	if(document.getElementById("schools").value!="Others")
	{
...
<<<<<<< HEAD
	if(!/^[0-3][0-9][\-]{1}[0-1][0-9][\-]{1}[0-9][0-9]$/.test(data.dob))
=======
...
>>>>>>> e23252e80bb556846beb0b1095f93862019f9777
	...
	{
		document.getElementById("errorroll_no").innerHTML = "Invalid Permanent Account number! Must be 10 digits long.";
	}
	else
...
<<<<<<< HEAD
	...
	if(/^[\w\.]{1,}$/.test(data.username))
	{
		document.getElementById("errorusername").innerHTML = "";count++;
	}
	else
	{
		document.getElementById("errorusername").innerHTML = "Username can have alphanumeric characters and periods";
	}
...
>>>>>>> e23252e80bb556846beb0b1095f93862019f9777
	...
	if(!(/^[\w]{0,}[\_]{1,}[\w]{0,}$/.test(data.password)) || !(/^[\w\_]{5,10}$/.test(data.password)))
	{
...
<<<<<<< HEAD
		{document.getElementById("errorpw").innerHTML = "";count++}
=======
...
>>>>>>> e23252e80bb556846beb0b1095f93862019f9777
	...
	else if(document.getElementById("captcha_reload").value==true)
	{
		count++;
<<<<<<< HEAD
		document.getElementById("errorcaptcha").innerHTML = "reloadvalue";
	}
	else
