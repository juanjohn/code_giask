...
function file_display(value,name){
		...
		inner_item2=document.createElement("td");
		inner_item2_text=document.createTextNode(name);
		complete_item2=inner_item2.appendChild(inner_item2_text);
		inner_item2.className="right";
		
		main_inner_item.appendChild(complete_item1);
		main_inner_item.appendChild(complete_item2);
				
		$("file_list_ul").appendChild(main_inner_item);
		
		inner_item2.style.color="red";
